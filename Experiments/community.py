...
N = 2000
l, m = 20, 20
csv = pd.read_csv("data/comm_graph20.csv", header=None)
data = csv.to_numpy().reshape((N, l, m))
...
plt.title("ROC Curve for Graph Seperation")
